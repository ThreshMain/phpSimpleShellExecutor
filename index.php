...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $password = $_POST["password"];
	 if ($name == '' || $password == '') {
        ...
        if ($password === $hardCodedPassword && $name === $hardCodedUserName) {
			echo 'Output: <pre style="border: 1px solid black">' . shell_exec('/bin/sudo -u root /home/root/discord-bot/clone.sh') . '</pre>';
            exit;
        }
